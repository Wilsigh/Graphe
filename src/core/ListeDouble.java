...
public class ListeDouble extends ArrayList<ArrayList<Integer>> {
   ...
   //     Gr = new ArrayList();
    ...
    /*
    * Cette fonction nous permet d'initilaiser le graph r�siduel tel que:
    * Gr=[[0],[1],...,[n]]
    */
    ...
    /*
    * Cette fonction nous permet de mettre de cot� les sommet isol� (seulement un voisin)
    * En effet, nous n'avons pas besoin de les traiter car ne pose aucun probl�me pour la planarit� du graphe
    * Mais nous devons les garder de cot� pour la fin du programme
    */
    ...
    /*
    * Graph R�siduel obtenue � l'aide de notre tout premier cycle
    */
    ...
    /*
    * Cela nous permet d'obtenir nos deux premi�re face (identique)
    */
    ...
    */
    ...
    /*
    * Rempli une liste nous permettant de savoir quel sont les sommet marqu�
    */
    ...
    /*
    * Met � jour notre composante connexe � l'aide d'un fragment que l'on a d�terminer dans une autre fonction
    */
    ...
    /*
    * Sert � mettre � jour les marque sur les sommets
    */
    ...
    //septique
    /*
    * Nous permet d'obtenir un fragment que l'on ppourra ajouter � Gr
    */
    ...
    * modifie les faces
    */
    //Seulement le cas pour deux face trait�, il faut finaliser la chose.
    ...
    /*
    * D�termination de la face en remplacant les �l�ment compris par les deux sommet marqu� par notre fagment
    */
    ...
    /*
    * De m�me mais en touchant � ce avant et apr�s les sommets marqu�
    */
    //� v�rifier
